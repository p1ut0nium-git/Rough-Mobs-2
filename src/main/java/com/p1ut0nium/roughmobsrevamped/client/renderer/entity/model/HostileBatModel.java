 ...
 * 
 */
package com.p1ut0nium.roughmobsrevamped.client.renderer.entity.model;
...
@OnlyIn(Dist.CLIENT)
public class HostileBatModel extends EntityModel<HostileBatEntity> {
   ...
   public void render(HostileBatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
      this.setRotationAngles(entityIn, limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch, scale);
      this.batHead.render(scale);
      this.batBody.render(scale);
   }

   public void setRotationAngles(HostileBatEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
