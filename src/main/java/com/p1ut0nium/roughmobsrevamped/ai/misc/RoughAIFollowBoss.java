...
public class RoughAIFollowBoss extends EntityAIBase
{
    ...
    public RoughAIFollowBoss(EntityTameable tameableIn, double followSpeedIn, float minDistIn, float maxDistIn)
    {
